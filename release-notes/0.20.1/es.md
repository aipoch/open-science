...
- **Detalles de sesión generados y editables**: un intento de generación por sesión mediante un ejecutor restringido sin herramientas, un diálogo de edición con contadores de caracteres que reemplaza una generación en curso y un modelo configurable para los detalles de sesión. (#1721)
...
- **Gráfico de ventana de contexto por llamada**: barras apiladas de entrada, caché y salida por llamada, un resumen de tres métricas, un panel de detalles fijado, una paleta atenuada del sistema de diseño y carriles por turno; la proyección del historial se difiere hasta que se abre el diálogo. (#1734, #1740, #1745)
...
- Todas las conexiones de red, incluidas las descargas y las solicitudes generadas, respetan de forma uniforme el modo de proxy configurado. (#1753)
- El cálculo del historial de la ventana de contexto se difiere hasta que se abre el diálogo, las ráfagas de actualización de instantáneas de notificaciones se agrupan y el análisis de habilidades del usuario se pospone, lo que reduce el tiempo de inicio. (#1745, #1702, #1700)
...
- **El historial de conversaciones** permanece intacto cuando las sesiones se guardan mediante escritores simultáneos: se exige la propiedad del grafo antes de las escrituras con autoridad, se conservan los identificadores de framework desconocidos y se validan las proyecciones. (#1746, #1722, #1726)
...
- **La computación remota** cancela las aprobaciones pendientes de sesiones eliminadas y el trabajo del sondeador durante el cierre, además de reforzar la coordinación de trabajos remotos. (#1716, #1737, #1724)
- **Los conectores** conservan las entradas de identificadores escalares, validan los argumentos de herramientas incluidas, limitan los recursos de respuesta del analizador y restringen las URL de autorización OAuth. (#1754, #1725, #1720, #1695)
...
- **La delegación** valida las solicitudes antes de admitirlas y aísla los mensajes restringidos de inferencia. (#1735, #1732)
- **Las sesiones y los proyectos** conservan las marcas de tiempo de actividad al archivarse, actualizaciones de tiempo monotónicas, el ciclo de vida confirmado del envío al revisor y preguntas de aclaración estructuradas en los planes de sesión. (#1719, #1711, #1709, #1701)
...
- **La elicitación** impone invariantes del esquema para que los formularios de respuesta personalizados sigan siendo válidos. (#1742)
