...
- **Interfaces.** _Shipping today_: a local Electron desktop app for individual researchers and small labs, with project/session management, a home page, and in-app update checks. A CLI/SDK for scripting and embedding, and an optional self-hosted web app for teams, are planned — both designed to eventually talk to the same orchestration core.
