...
> 💡 **[Open Science v0.22.0 released](https://github.com/aipoch/open-science/releases/latest)** _(last updated August 2026)_. Open Science v0.22.0 adds persistent agent memory that carries knowledge across sessions, provenance-aware figure workflows in the bundled skills, centralized credential management for GitHub tokens and connector sign-ins, and a fuller usage dashboard that attributes tokens to their runs and counts auxiliary model calls — alongside the Tencent TokenHub model provider, safer update downloads and runtime installs, and a long list of session, Claude-backend, and localhost-service fixes. See the [latest release notes](https://github.com/aipoch/open-science/releases/latest) for full details.
