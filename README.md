...
> 💡 **[Open Science v0.18.0 released](https://github.com/aipoch/open-science/releases/latest)** _(last updated August 2026)_. Open Science v0.18.0 introduces cross-resource catalog tags with Favorites and drag ordering, redesigned skill management, and a faster Specialist marketplace with instant cached browsing, capability icons, and quick appearance editing. Compute hosts now support SSH password authentication with OS-encrypted credentials, while Korean localization and multilingual README and contribution guides broaden access. The release also improves marketplace and connector loading, runtime event streaming, protected deletion, atomic onboarding persistence, and recovery across startup, sessions, compute, and updates. See the [latest release notes](https://github.com/aipoch/open-science/releases/latest) for full details.
...
| **Models**                   | Built-in cloud providers, custom compatible gateways, Claude and Codex subscription logins, connection validation, per-model multimodal image input, a combined composer picker for model and model-supported reasoning effort, hot-switching of compatible models and providers without reconnecting the agent process, and a dedicated Vision model selector with a persistent image evidence relay for text-only backends. Available providers and API formats are validated against the selected agent backend.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
