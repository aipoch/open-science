...
> 💡 **[Open Science v0.23.0 released](https://github.com/aipoch/open-science/releases/latest)** _(last updated August 2026)_. Open Science v0.23.0 lets the agent read the papers you read: link up to three PDFs to a session as reading context, let the agent read, page through, and search them, and highlight text or regions as evidence with click-to-reveal in the source — alongside live kernel variable suggestions and a docked Variables pane in the notebook, Tencent Coding Plan and Token Plan subscriptions, notebook workload caches that follow the configured storage location, and a broad set of storage-integrity, remote-access, and credential fixes. See the [latest release notes](https://github.com/aipoch/open-science/releases/latest) for full details.
