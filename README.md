...
<p align="center">
  ...
  <a href="./docs/pt-BR/README.md"><img alt="README in Brazilian Portuguese" src="https://img.shields.io/badge/Português%20(Brasil)-d9d9d9"></a>
...
> 💡 **[Open Science v0.20.1 released](https://github.com/aipoch/open-science/releases/latest)** _(last updated August 2026)_. Open Science v0.20.1 adds generated and editable session details (title + description), a composer draft redo shortcut, MCP client-config import/export with credential placeholders, per-model-call usage details with a redesigned per-call context-window chart, and correlated HTTP request diagnostics — alongside proxy-consistent networking, validated downloads, hardened remote-access pairing, and a long list of session, notebook, connector, compute, and provider fixes. See the [latest release notes](https://github.com/aipoch/open-science/releases/latest) for full details.
...
| **Distribution and support** | Installers for macOS, Windows, and Linux; a streamlined first-run onboarding wizard for environment, agent runtime, model provider, notebook runtime, and data location; interface localization in Spanish, French, Chinese (Simplified and Traditional), Japanese, Korean, Brazilian Portuguese, and Russian with README translations for every supported language and additional multilingual contribution guides; update guidance with prominent update reminders; local diagnostics; and community links.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
