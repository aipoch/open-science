...
> 💡 **[AIPOCH Open-Science v0.33.0 released](https://github.com/aipoch/open-science/releases/latest)** _(last updated September 2026)_. AIPOCH Open-Science v0.33.0 brings screening-grade literature triage: smart Literature collections evaluate references against your inclusion and exclusion criteria, with Included / Needs review / Excluded states, PDF evidence, and opt-in automatic updates. Research packages now embed RO-Crate metadata (newly exported packages need an ro-crate-capable reader; existing packages stay readable), and the connector family grows with Zenodo public record discovery, GDC project and file metadata, and UniProt batch identifier mapping. Per-agent resource access controls bring skills and connector permissions for the main agent and specialists into one place, sessions gain a local diagnostic export, and the provider catalogs refresh with Xiaomi MiMo v2.6, Grok 4.7, and current-generation models across Zen and Go. Notebook environment and recovery notices became dismissible, Windows package reset clears read-only attributes, Linux packages ship the Fedora query engine, and streaming stays responsive with bounded token estimation. See the [latest release notes](https://github.com/aipoch/open-science/releases/latest) for full details.
...
| **Connectors**                                | Access scientific resources through **27 built-in connectors**, or add custom local and remote MCP connectors. Manage tool-level permissions and import or export connector configurations.                                                                                                                                                                                                                                                                      |
