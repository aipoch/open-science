...
> 💡 **[Open Science v0.20.2 released](https://github.com/aipoch/open-science/releases/latest)** _(last updated August 2026)_. Open Science v0.20.2 adds a complete Spanish interface, in-app sandboxed previews for source links in agent responses, a live variable browser for running notebook kernels, session hover previews in the sidebar, right-click preview-tab actions, and new OpenCode Go and Zen providers plus GLM-5.3 family models — alongside faster conversation rendering, bounded session save cadence for long-running sessions, and session persistence, plan preview, archiving, and notebook fixes. See the [latest release notes](https://github.com/aipoch/open-science/releases/latest) for full details.
