...
describe('key shape', () => {
  it.each(TRANSLATED)('%s keys carry no underscore inside the English text', (locale) => {
    // Only i18next's own plural suffixes are allowed. The disambiguating suffixes this list used to
    // carry (`_ago`, `_step`, `_verb`, …) belonged to keys that no call site resolved; they were
    // deleted, so allowing them here would only license a new one to appear unnoticed.
    const suffixes = new Set(PLURAL_CATEGORIES)
...
const SCAN_ROOTS = [join(SRC_ROOT, 'renderer', 'src'), join(SRC_ROOT, 'shared')]
...
// checked; keys that arrive through a lookup table are invisible here, and the orphan guard covers
// those instead.
...
const tCallSites = (source: string): CallSite[] => {
  ...
  for (let i = 0; i < source.length - 2; i += 1) {
    ...
    const literal = readStringLiteral(source, skipSpace(source, i + 2))
    if (!literal) continue
    // The option object, when there is one, sits between the literal and the call's closing paren.
    ...
    sites.push({
      ...
      context: /\bcontext\s*:\s*['"]([^'"]+)['"]/.exec(options)?.[1] ?? null
    })
  }
  return sites
}
...
const KNOWN_BARE = new Set([
  'renderer/src/components/Versions.tsx: "Electron v"',
  'renderer/src/components/Versions.tsx: "Chromium v"',
  'renderer/src/components/Versions.tsx: "Node v"',
  'renderer/src/pages/settings/ActiveModelSelect.tsx: "· not usable with this framework"',
  'renderer/src/pages/settings/ConnectorImportView.tsx: "Choose one .json file up to"',
  'renderer/src/pages/settings/ConnectorImportView.tsx: "Use configuration"',
  'renderer/src/pages/settings/ConnectorsPanel.tsx: "Remove “"',
  'renderer/src/pages/settings/ConnectorsPanel.tsx: "This Connector is used by"',
  'renderer/src/pages/settings/PermissionsPanel.tsx: "Also allowed"',
  'renderer/src/pages/settings/PermissionsPanel.tsx: "Try again"',
  'renderer/src/pages/settings/PermissionsPanel.tsx: "Revoke all"',
  'renderer/src/pages/settings/RemoteControlPanel.tsx: "Scan the QR code or open the saved link in a browser."',
  'renderer/src/pages/settings/RemoteControlPanel.tsx: "Complete two-step verification by matching the six-digit code, then approve the request from this computer or a trusted browser."',
  'renderer/src/pages/settings/RemoteControlPanel.tsx: "Choose “Always trust this browser” for direct access on future visits while Browser access is on."',
  'renderer/src/pages/settings/RemoteControlPanel.tsx: "Open the mobile app and sign in to the same account as this computer."',
  'renderer/src/pages/settings/RemoteControlPanel.tsx: "Select this computer, then select"',
  'renderer/src/pages/settings/RemoteControlPanel.tsx: "Tap Connect or Launch, match the six-digit code, then approve the request from this computer or an already trusted browser."',
  'renderer/src/pages/settings/RemoteControlPanel.tsx: "Choose “Always trust this browser” to skip approval on future visits to the same remote address."',
  'renderer/src/pages/settings/RemoteControlPanel.tsx: "Last used"',
  'renderer/src/pages/settings/RemoteControlPanel.tsx: "Requested"',
  'renderer/src/pages/settings/RemoteControlPanel.tsx: "Reject"',
  'renderer/src/pages/settings/RemoteControlPanel.tsx: "Allow once"',
  'renderer/src/pages/settings/RemoteControlPanel.tsx: "Always trust this browser"',
  'renderer/src/pages/settings/SpecialistEditor.tsx: "Imported · Original version"',
  'renderer/src/pages/settings/SpecialistEditor.tsx: "Default"',
  'renderer/src/pages/settings/SpecialistEditor.tsx: "Skills"',
  'renderer/src/pages/settings/SpecialistEditor.tsx: "Connectors"',
  'renderer/src/pages/settings/SpecialistEditor.tsx: "＋ Add a skill"',
  'renderer/src/pages/settings/SpecialistEditor.tsx: "＋ Add a connector"',
  'renderer/src/pages/settings/SpecialistEditor.tsx: "Unavailable —"',
  'renderer/src/pages/settings/SpecialistsPanel.tsx: "Back"',
  'renderer/src/pages/settings/SpecialistsPanel.tsx: "Done"',
  'renderer/src/pages/settings/SpecialistsPanel.tsx: "Connectors:"',
  'renderer/src/pages/settings/SpecialistsPanel.tsx: "Cancel"',
  'renderer/src/pages/settings/SpecialistsPanel.tsx: "Choose ZIP"',
  'renderer/src/pages/settings/SpecialistsPanel.tsx: "Up to"',
  'renderer/src/pages/settings/SpecialistsPanel.tsx: "Import failed:"',
  'renderer/src/pages/settings/SpecialistsPanel.tsx: "Export current version first"',
  'renderer/src/pages/settings/SpecialistsPanel.tsx: "Overwrite and continue"',
  'renderer/src/pages/settings/SpecialistsPanel.tsx: "Back to specialists"',
  'renderer/src/pages/settings/SpecialistsPanel.tsx: "Built-in · Version"',
  'renderer/src/pages/settings/SpecialistsPanel.tsx: "Actions for"',
  'renderer/src/pages/settings/SpecialistsPanel.tsx: "Delete “"',
  'renderer/src/pages/settings/SpecialistsPanel.tsx: "Delete Specialist"',
  'renderer/src/pages/workspace/ArtifactProvenancePanel.tsx: "Loading"',
  'renderer/src/pages/workspace/ArtifactProvenancePanel.tsx: "Artifact content is"',
  'renderer/src/pages/workspace/ArtifactProvenancePanel.tsx: "Generate script"',
  'renderer/src/pages/workspace/ArtifactProvenancePanel.tsx: "Retry"',
  'renderer/src/pages/workspace/ArtifactProvenancePanel.tsx: "No producer block was recorded for this version."',
  'renderer/src/pages/workspace/ArtifactProvenancePanel.tsx: "Execution evidence was bounded for storage: omitted"',
  'renderer/src/pages/workspace/ComposerContextUsage.tsx: "Local"',
  'renderer/src/pages/workspace/ComposerModelPicker.tsx: "Default"',
  'renderer/src/pages/workspace/ComposerModelPicker.tsx: "Unavailable for"',
  'renderer/src/pages/workspace/DownloadSessionArtifactsDialog.tsx: "Retry"',
  'renderer/src/pages/workspace/PermissionApprovalControls.tsx: "Remembered scopes apply to commands starting with:"',
  'renderer/src/pages/workspace/PermissionScopeConfirmationDialog.tsx: "Allow"',
  'renderer/src/pages/workspace/ProjectFilesView.tsx: "Retry loading sessions"',
  'renderer/src/pages/workspace/SessionReviewerPanel.tsx: "Ref:"',
  'renderer/src/pages/workspace/SessionReviewerPanel.tsx: "· hash"',
  'renderer/src/pages/workspace/SessionReviewerPanel.tsx: "● ok"',
  'renderer/src/pages/workspace/SessionReviewerPanel.tsx: "● error"',
  'renderer/src/pages/workspace/WorkspaceSidebar.tsx: "Download all artifacts"',
  'renderer/src/pages/workspace/WorkspaceSidebar.tsx: "Markdown"',
  'renderer/src/pages/workspace/WorkspaceSidebar.tsx: "PDF"',
  'renderer/src/pages/workspace/previews/renderers/CsvPreview.tsx: "Showing"',
  'renderer/src/pages/workspace/previews/renderers/PdfPreview.tsx: "Page"',
  'renderer/src/pages/workspace/previews/renderers/TiffPreview.tsx: "Page"',
  'renderer/src/pages/workspace/session-plan/SessionPlanSurfaces.tsx: "⚠ A newer plan is active. This plan can no longer be approved."',
  'renderer/src/pages/workspace/session-plan/SessionPlanSurfaces.tsx: "Dismiss"',
  'renderer/src/pages/workspace/session-plan/SessionPlanSurfaces.tsx: "Approve"',
  'renderer/src/pages/workspace/session-plan/SessionPlanSurfaces.tsx: "⚠ This plan has been replaced by another plan and is no longer current."',
  'renderer/src/pages/workspace/session-plan/SessionPlanSurfaces.tsx: "Complete"',
  'renderer/src/pages/workspace/session-plan/SessionPlanSurfaces.tsx: "PHASE"'
])
