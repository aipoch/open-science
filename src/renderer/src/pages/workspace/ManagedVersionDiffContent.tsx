        ...
        {blocks.map((block) => {
          if (block.kind === 'markdown') {
            ...
            return block.changeKind === 'added' ? (
              <ins
                ...
                className="block min-w-0 bg-diff-added-surface px-4 font-sans font-medium text-diff-added-foreground no-underline"
              ...
              <del
                ...
                className="block min-w-0 bg-diff-removed-surface px-4 font-sans text-diff-removed-foreground line-through"
          ...
          const tone =
            block.changeKind === 'added'
              ...
              : block.changeKind === 'removed'
                ? 'bg-diff-removed-surface'
                : ''
          return (
            <div
              key={`text:${block.startIndex}`}
              className={`min-h-6 px-4 ${tone}`}
              data-diff-kind={block.changeKind}
            >
