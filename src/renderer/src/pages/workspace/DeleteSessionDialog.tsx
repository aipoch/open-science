        ...
        >
          ...
          <div className={dialogBodyClassName}>
            <AlertDialog.Description className={dialogDescriptionClassName}>
              {t(
                'This will permanently delete "{{title}}". Artifacts created in this session will remain in the project. Files in its Session workspace are not deleted and remain available in Settings → Storage. This action cannot be undone.',
