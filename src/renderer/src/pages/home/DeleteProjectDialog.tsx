            ...
            <AlertDialog.Description className={dialogDescriptionClassName}>
              ...
              {dialogHasCompleteSessionCatalog
                ? dialogSessionCount > 0
                  ? t(
                      'This will permanently delete "{{name}}" and its {{count}} sessions. Generated artifacts and uploaded files stored by Open Science will also be deleted. Files in Session workspaces are not deleted and remain available in Settings → Storage. This action cannot be undone.',
                      {
                        defaultValue_one:
                          'This will permanently delete "{{name}}" and its {{count}} session. Generated artifacts and uploaded files stored by Open Science will also be deleted. Files in Session workspaces are not deleted and remain available in Settings → Storage. This action cannot be undone.',
