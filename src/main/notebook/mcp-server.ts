...
const NOTEBOOK_RPC_TOOLS: NotebookRpcToolDefinition[] = [
  ...
  },
  {
    ...
    description:
      "Reuse cellId. helperModules: IDs on every dependent call. artifactVersionInputs: this Run's provenance inputs (Version IDs). Binding selects runtime. Use runId as producerRunId.",
    method: 'execute',
