// Literature annotations can belong to an immutable version without a Project or Session.
const literaturePdfAnnotationsMigration = {
          ...
          constraints: [
            {
              ...
              expression: `("projectId" IS NOT NULL AND "sessionId" IS NOT NULL) OR ("projectId" IS NULL AND "sessionId" IS NULL AND "sourceKind" = 'literature-attachment-version' AND "sourceSessionId" IS NULL)`
            }
          ]
        }
      ]
...
export { literaturePdfAnnotationsMigration }
