...
const RUNTIME_SCHEMA_TABLE_DDLS = [
  ...
  `CREATE TABLE IF NOT EXISTS "LiteratureAttachment" (
    "id" TEXT NOT NULL PRIMARY KEY,
  ...
  `CREATE TABLE IF NOT EXISTS "LiteratureAttachmentVersion" (
    "id" TEXT NOT NULL PRIMARY KEY,
  ...
  `CREATE TABLE IF NOT EXISTS "LiteratureItemCreator" (
    "itemId" TEXT NOT NULL,
  ...
  `CREATE TABLE IF NOT EXISTS "LiteratureInboxCandidate" (
    "id" TEXT NOT NULL PRIMARY KEY,
    "dedupeKey" TEXT NOT NULL,
  ...
  `CREATE TABLE IF NOT EXISTS "LiteratureCollectionItem" (
  ...
  `CREATE TABLE IF NOT EXISTS "ProjectLiterature" (
    "projectId" TEXT NOT NULL,
    "itemId" TEXT NOT NULL,
    "source" TEXT NOT NULL,
    "addedAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  ...
  `CREATE TABLE IF NOT EXISTS "ArtifactLiteratureManifest" (
...
const RUNTIME_SCHEMA_INDEX_DDLS = [
  ...
  `CREATE INDEX IF NOT EXISTS "LiteratureItem_itemType_issuedYear_idx" ON "LiteratureItem"("itemType", "issuedYear");`,
  `CREATE INDEX IF NOT EXISTS "LiteratureItem_title_idx" ON "LiteratureItem"("title");`,
  `CREATE INDEX IF NOT EXISTS "LiteratureItem_citationKey_idx" ON "LiteratureItem"("citationKey");`,
  `CREATE INDEX IF NOT EXISTS "LiteratureAttachment_itemId_sortOrder_idx" ON "LiteratureAttachment"("itemId", "sortOrder");`,
  `CREATE INDEX IF NOT EXISTS "LiteratureAttachmentVersion_contentBlobId_idx" ON "LiteratureAttachmentVersion"("contentBlobId");`,
  `CREATE UNIQUE INDEX IF NOT EXISTS "LiteratureAttachmentVersion_attachmentId_versionNumber_key" ON "LiteratureAttachmentVersion"("attachmentId", "versionNumber");`,
  `CREATE UNIQUE INDEX IF NOT EXISTS "LiteratureAttachmentVersion_attachmentId_checksum_key" ON "LiteratureAttachmentVersion"("attachmentId", "checksum");`,
  `CREATE INDEX IF NOT EXISTS "LiteratureCreator_normalizedName_idx" ON "LiteratureCreator"("normalizedName");`,
  `CREATE INDEX IF NOT EXISTS "LiteratureItemCreator_creatorId_idx" ON "LiteratureItemCreator"("creatorId");`,
  `CREATE INDEX IF NOT EXISTS "LiteratureItemCreator_itemId_creatorType_idx" ON "LiteratureItemCreator"("itemId", "creatorType");`,
  `CREATE INDEX IF NOT EXISTS "LiteratureIdentifier_scheme_normalizedValue_idx" ON "LiteratureIdentifier"("scheme", "normalizedValue");`,
  `CREATE INDEX IF NOT EXISTS "LiteratureIdentifier_itemId_isPrimary_idx" ON "LiteratureIdentifier"("itemId", "isPrimary");`,
  `CREATE UNIQUE INDEX IF NOT EXISTS "LiteratureIdentifier_itemId_scheme_normalizedValue_key" ON "LiteratureIdentifier"("itemId", "scheme", "normalizedValue");`,
  `CREATE UNIQUE INDEX IF NOT EXISTS "LiteratureInboxCandidate_dedupeKey_key" ON "LiteratureInboxCandidate"("dedupeKey");`,
  ...
  `CREATE INDEX IF NOT EXISTS "LiteratureCollectionItem_collectionId_sortOrder_idx" ON "LiteratureCollectionItem"("collectionId", "sortOrder");`,
  `CREATE INDEX IF NOT EXISTS "ProjectLiterature_itemId_idx" ON "ProjectLiterature"("itemId");`,
  `CREATE INDEX IF NOT EXISTS "ProjectLiterature_projectId_addedAt_idx" ON "ProjectLiterature"("projectId", "addedAt");`,
  ...
  `CREATE INDEX IF NOT EXISTS "UploadVersion_contentBlobId_idx" ON "UploadVersion"("contentBlobId");`,
  ...
  `CREATE INDEX IF NOT EXISTS "ArtifactVersion_contentBlobId_idx" ON "ArtifactVersion"("contentBlobId");`,
