...
describe('Compute service architecture', () => {
  ...
  it('registers the complete facade, owner and cross-surface certification boundary', () => {
    ...
    expect(computeService.ownerPaths).toEqual([
      ...
      'src/main/compute/cancellation-feedback.ts',
      'src/main/compute/cancellation-feedback.test.ts',
      'src/main/compute/remote-execution-scope.ts',
      'src/main/compute/remote-job-supervisor.ts',
      'src/main/compute/remote-job-process.shell.test.ts',
      'src/main/compute/remote-job-tree.real-ssh.integration.test.ts'
    ])
