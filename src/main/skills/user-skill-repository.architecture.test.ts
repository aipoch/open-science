  ...
  it('declares complete ownership and downstream test impact', () => {
    ...
    expect(manifest.modules.user_skills_repository).toEqual({
      ownerPaths: [
        ...
        'src/main/skills/skill-package-transaction-owner.ts',
        'src/main/skills/__fixtures__/marketplace/README.md',
        'src/main/skills/__fixtures__/marketplace/abstract-trimmer.json',
        'src/main/skills/__fixtures__/marketplace/marketplace.json',
        'src/main/skills/__fixtures__/marketplace/marketplace.json.sig',
        'src/main/skills/__fixtures__/marketplace/release-index.json',
        'src/main/skills/activation-policy.ts',
        'src/main/skills/builtin-specialist-package-adapter.ts',
        'src/main/skills/conversation-import.test.ts',
        'src/main/skills/conversation-import.ts',
        'src/main/skills/env-management-skill.test.ts',
        'src/main/skills/export.test.ts',
        'src/main/skills/export.ts',
        'src/main/skills/frontmatter.test.ts',
        'src/main/skills/frontmatter.ts',
        'src/main/skills/github-import.test.ts',
        'src/main/skills/github-import.ts',
        'src/main/skills/host-skills-service.test.ts',
        'src/main/skills/host-skills-service.ts',
        'src/main/skills/import-limits.test.ts',
        'src/main/skills/import-limits.ts',
        'src/main/skills/marketplace-install-queue.test.ts',
        'src/main/skills/marketplace-install-queue.ts',
        'src/main/skills/marketplace-installation.test.ts',
        'src/main/skills/marketplace-package.ts',
        'src/main/skills/marketplace-protocol.ts',
        'src/main/skills/marketplace-service.test.ts',
        'src/main/skills/marketplace-service.ts',
        'src/main/skills/marketplace-source.ts',
        'src/main/skills/materializer-integrity.regression.test.ts',
        'src/main/skills/materializer.test.ts',
        'src/main/skills/materializer.ts',
        'src/main/skills/mcp-server.test.ts',
        'src/main/skills/mcp-server.ts',
        'src/main/skills/net-fetch.test.ts',
        'src/main/skills/net-fetch.ts',
        'src/main/skills/registered-helper-catalog.test.ts',
        'src/main/skills/registered-helper-catalog.ts',
        'src/main/skills/registry.test.ts',
        'src/main/skills/registry.ts',
        'src/main/skills/resource-path.ts',
        'src/main/skills/runtime-mcp-server.test.ts',
        'src/main/skills/runtime-mcp-server.ts',
        'src/main/skills/self-awareness-skill.test.ts',
        'src/main/skills/skill-archive-sniffer.test.ts',
        'src/main/skills/skill-archive-sniffer.ts',
        'src/main/skills/skill-bundle-paths.ts',
        'src/main/skills/skill-document-name.ts',
        'src/main/skills/skill-files.ts',
        'src/main/skills/skill-name.ts',
        'src/main/skills/skill-nudge-identity.test.ts',
        'src/main/skills/skill-package-compatibility.ts',
        'src/main/skills/skill-package-inspection.ts',
      ...
      testFiles: {
        ...
        consumer: [
          ...
          'src/main/connectors/descriptors/genomes-ucsc.test.ts',
          'src/main/connectors/descriptors/literature-doi.test.ts',
          ...
          'src/main/literature/full-text-sources.test.ts',
          ...
          'src/main/notebook/mirror-probe.test.ts',
          ...
          'src/main/settings/managed-claude.test.ts',
          'src/main/settings/managed-codebuddy.test.ts',
          'src/main/settings/managed-codex.test.ts',
          'src/main/settings/managed-opencode.test.ts',
          ...
          'src/main/update/create-strategy.test.ts',
          'src/main/update/downloader.test.ts',
          'src/main/update/electron-updater-provider-regressions.test.ts',
          'src/main/update/electron-updater-strategy.test.ts',
          'src/main/update/ipc.test.ts',
          'src/main/update/legacy-shell-recovery.integration.test.ts',
          'src/main/update/manifest.test.ts',
          'src/main/update/service.save-dialog.test.ts',
          'src/main/update/service.test.ts',
          'src/main/update/update-integrity-regressions.test.ts',
