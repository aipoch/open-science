...
const api: OpenScienceAPI = {
  ...
  sessions: {
    ...
    setArchived: (request) => electronRendererContracts.invoke('sessions.setArchived', request),
  ...
  projects: {
    ...
    setArchived: (request) => electronRendererContracts.invoke('projects.setArchived', request),
