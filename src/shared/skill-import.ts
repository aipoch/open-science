...
const REQUEST_SKILL_IMPORT_TOOL_DESCRIPTION =
  'Open the application-owned preview and confirmation dialog for a Skill source the user explicitly asked to install. For an eligible .zip or .skill attachment, pass its exact attachment_uri and turn_token. For a public GitHub Skill, pass its exact github_url. Use exactly one source, never guess a URI or URL, and do not write anything unless the user confirms.'
