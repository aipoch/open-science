...
const REMOTE_LOCAL_ONLY_CHANNELS: GroupedInventory = {
  'pdf-structure': ['parse', 'cancel', 'read-thumbnail', 'clear-cache'],
  ...
  settings: [
    ...
    'create-wsl-support-handoff',
    'disconnect-custom-server',
    'disconnect-device-credential',
    'get-github-token-status',
    'get-local-shell-runtime-preference',
    'get-notebook-network-status',
    'get-wsl-setup-status',
    'get-wsl2-bash-preview-status',
    'install-claude',
    'install-codebuddy',
    'install-codex',
    ...
    'switch-local-shell-to-powershell',
    'uninstall-claude',
    'uninstall-codebuddy',
    'uninstall-codex',
    'uninstall-opencode',
