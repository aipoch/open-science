...
export const WEB_INVOKE_CHANNELS = {
  ...
  'settings.replayPendingConnectorCredentialRequests': 'connectors:credential-replay-pending',
  ...
  'settings.respondConnectorCredentialRequest': 'connectors:credential-respond',
...
export const WEB_EVENT_CHANNELS = {
  ...
  'settings.onConnectorCredentialRequest': 'connectors:credential-request',
  'settings.onConnectorCredentialSettled': 'connectors:credential-settled',
