...
export const WEB_INVOKE_CHANNELS = {
  ...
  'artifacts.getVersionLiterature': 'artifacts:get-version-literature',
  ...
  'bookmarks.resolvePdfSource': 'bookmarks:resolve-pdf-source',
  'bookmarks.updateNote': 'bookmarks:update-note',
  ...
  'literature.cancelPdfImport': 'literature:cancel-pdf-import',
  ...
  'localModels.cancel': 'local-models:cancel',
  'localModels.getSnapshot': 'local-models:get-snapshot',
  'localModels.install': 'local-models:install',
  'localModels.remove': 'local-models:remove',
  ...
  'notebook.cancelBackgroundRun': 'notebook:cancel-background-run',
  ...
  'pdfAnnotations.cancelImport': 'pdf-annotations:cancel-import',
  'pdfAnnotations.create': 'pdf-annotations:create',
  'pdfAnnotations.delete': 'pdf-annotations:delete',
  'pdfAnnotations.importNative': 'pdf-annotations:import-native',
  'pdfAnnotations.list': 'pdf-annotations:list',
  'pdfAnnotations.update': 'pdf-annotations:update',
  ...
  'projectFiles.getHiddenArtifactIds': 'project-files:get-hidden-artifact-ids',
  ...
  'projectFiles.readHiddenArtifact': 'project-files:read-hidden-artifact',
  ...
  'projectFiles.setArtifactHidden': 'project-files:set-artifact-hidden',
  'projects.create': 'projects:create',
  'projects.delete': 'projects:delete',
  'projects.get': 'projects:get',
  'projects.list': 'projects:list',
  'projects.listDeletionCleanup': 'projects:list-deletion-cleanup',
  'projects.retryDeletionCleanup': 'projects:retry-deletion-cleanup',
  ...
  'runtime.getAgentEnvironmentCreationEnabled': 'runtime:get-agent-environment-creation-enabled',
  ...
  'sessions.exportDiagnostics': 'sessions:export-diagnostics',
  ...
  'sessions.inspectDiagnostics': 'sessions:inspect-diagnostics',
  ...
  'sessions.packageOperation': 'sessions:package-operation',
  ...
  'settings.authenticateDeviceCredential': 'settings:authenticate-device-credential',
  ...
  'settings.getClassification': 'settings:get-classification',
  ...
  'settings.getSkillMarketplaceDetail': 'settings:get-skill-marketplace-detail',
  'settings.getWsl2BashPreviewStatus': 'settings:get-wsl2-bash-preview-status',
  'settings.getWslSetupStatus': 'settings:get-wsl-setup-status',
  ...
  'settings.listDeviceCredentials': 'settings:list-device-credentials',
  ...
  'settings.openWslTerminal': 'settings:open-wsl-terminal',
  ...
  'settings.probeWslSetup': 'settings:probe-wsl-setup',
  'settings.refreshProviderModels': 'settings:refresh-provider-models',
  'settings.removeCustomServer': 'settings:remove-custom-server',
  'settings.removeDeviceCredential': 'settings:remove-device-credential',
  'settings.removeGitHubToken': 'settings:remove-github-token',
  'settings.removeNotebookNetwork': 'settings:remove-notebook-network',
  ...
  'settings.setNotebookNetwork': 'settings:set-notebook-network',
  'settings.setNotificationsEnabled': 'settings:set-notifications-enabled',
  'settings.setOpenAlexCredential': 'settings:set-openalex-credential',
  ...
  'settings.startSkillMarketplaceBatch': 'settings:start-skill-marketplace-batch',
  'settings.stopSkillMarketplaceBatch': 'settings:stop-skill-marketplace-batch',
  'settings.switchLocalShellToPowerShell': 'settings:switch-local-shell-to-powershell',
  'settings.testClassification': 'settings:test-classification',
  ...
  'settings.updateClassification': 'settings:update-classification',
  ...
  'specialist.abortPackageUpload': 'specialist:package-upload-abort',
  'specialist.beginPackageUpload': 'specialist:package-upload-begin',
  'specialist.cancelPackage': 'specialist:package-cancel',
  'specialist.installPackage': 'specialist:package-install',
...
export const WEB_EVENT_CHANNELS = {
  ...
  'pdfAnnotations.onChanged': 'pdf-annotations:changed',
  'pdfAnnotations.onImportProgress': 'pdf-annotations:import-progress',
  ...
  'projects.onDeletionCleanupChanged': 'project:deletion-cleanup-changed',
  ...
  'sessions.onFlushRequest': 'sessions:flush-request',
  'sessions.onPackageOperation': 'sessions:package-operation-changed',
  ...
  'specialist.onCatalogChanged': 'specialist:catalog-changed',
