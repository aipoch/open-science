...
export const RENDERER_CONTRACT_GROUPS = Object.freeze([
  ...
  group('compute', 'compute', [
    ...
    ['list', 'compute:list'], ['listDir', 'compute:list-dir'], ['probe', 'compute:probe'], ['replayApproval', 'compute:approval-replay'], ['replayPendingApprovals', 'compute:approval-replay-pending'], ['respondApproval', 'compute:approval-respond'],
