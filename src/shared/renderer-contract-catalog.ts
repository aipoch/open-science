...
export const RENDERER_CONTRACT_GROUPS = Object.freeze([
  ...
  group('projects', 'projects', [
    ...
    ['delete', 'projects:delete'], ['get', 'projects:get'], ['list', 'projects:list'], ['setArchived', 'projects:set-archived'], ['update', 'projects:update'],
  ]),
  ...
  group('sessions', 'sessions', [
    ...
    ['saveSession', 'sessions:save-session', WEB, SESSION_SAVE, SESSION_SAVE_JSON], ['setArchived', 'sessions:set-archived'], ['sendFlushResponse', 'sessions:flush-response', SEND],
  ]),
