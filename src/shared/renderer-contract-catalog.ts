...
export const RENDERER_CONTRACT_GROUPS = Object.freeze([
  ...
  group('settings', 'settings', [
    ['addCustomServer', 'settings:add-custom-server'], ['authenticateCustomServer', 'settings:authenticate-custom-server', LOCAL], ['cancelClaudeLogin', 'settings:cancel-claude-login', LOCAL],
