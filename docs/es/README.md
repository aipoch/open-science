...
> 💡 **[AIPOCH Open-Science v0.33.0 publicado](https://github.com/aipoch/open-science/releases/latest)** _(última actualización en septiembre de 2026)_. AIPOCH Open-Science v0.33.0 incorpora un cribado de literatura de calidad de revisión: las colecciones inteligentes de Literature evalúan las referencias según sus criterios de inclusión y de exclusión, con estados Incluida / Requiere revisión / Excluida, evidencia en PDF y actualizaciones automáticas opcionales. Los paquetes de investigación incorporan ahora metadatos RO-Crate (los paquetes recién exportados necesitan un lector compatible con ro-crate; los existentes siguen siendo legibles), y la familia de conectores crece con el descubrimiento de registros públicos de Zenodo, los metadatos de proyectos y archivos de GDC y la asignación por lotes de identificadores de UniProt. Los controles de acceso a recursos por agente reúnen en un solo lugar los permisos de habilidades y conectores del agente principal y de los especialistas, las sesiones incorporan una exportación de diagnósticos local, y los catálogos de proveedores se renuevan con Xiaomi MiMo v2.6, Grok 4.7 y modelos de la generación actual en Zen y Go. Los avisos de entorno y de recuperación de Notebook se pueden descartar, el restablecimiento de paquetes de Windows limpia los atributos de solo lectura, los paquetes de Linux incluyen el motor de consultas de Fedora y el streaming sigue respondiendo gracias a una estimación de tokens acotada. Consulte las [notas de la versión más recientes](https://github.com/aipoch/open-science/releases/latest) para obtener todos los detalles.
