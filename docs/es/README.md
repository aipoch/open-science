...
> 💡 **[AIPOCH Open-Science v0.31.0 publicado](https://github.com/aipoch/open-science/releases/latest)** _(última actualización en septiembre de 2026)_. AIPOCH Open-Science v0.31.0 permite bifurcar una sesión escribible con todo su historial de investigación —ramas de conversación, registros del Notebook, artefactos, literatura y marcadores—, mientras las sesiones importadas permanecen de solo lectura. El nombre del producto se unifica ahora como Open-Science, conservando las instalaciones existentes y todos los datos de investigación. Los planes de sesión recuperan su contexto tras la reconstrucción del agente, las conexiones de proveedores se validan antes de guardarse, el conector gnomAD puede devolver frecuencias a nivel de población, y las sesiones bifurcadas muestran un divisor de continuación hacia su origen. R en Windows funciona de nuevo en modo estándar sin configuración de modo protegido, y los conectores, los diálogos y la gestión de permisos se afinan en conjunto. Consulte las [notas de la versión más recientes](https://github.com/aipoch/open-science/releases/latest) para obtener todos los detalles.
