...
<p align="center">
  ...
  <a href="../pt-BR/README.md"><img alt="README en portugués de Brasil" src="https://img.shields.io/badge/Português%20(Brasil)-d9d9d9"></a>
...
> 💡 **[Open Science v0.20.2 publicado](https://github.com/aipoch/open-science/releases/latest)** _(última actualización en agosto de 2026)_. Open Science v0.20.2 incorpora una interfaz completa en español, vistas previas seguras dentro de la app de los enlaces de fuentes en las respuestas del agente, un explorador de variables en vivo para los kernels de Notebook en ejecución, vistas previas al pasar el cursor sobre las sesiones en la barra lateral, un menú contextual de clic derecho para las pestañas de vista previa, y los proveedores OpenCode Go y Zen junto con los modelos de la familia GLM-5.3. También acelera el renderizado de conversaciones, limita la frecuencia de guardado de las sesiones largas y corrige problemas de persistencia de sesiones, vista previa de planes, archivado y Notebooks. Consulte las [notas de la versión más recientes](https://github.com/aipoch/open-science/releases/latest) para obtener todos los detalles.
...
5. **Ubicación de datos** permite elegir dónde se almacenan los artefactos, Notebooks, cargas y entornos de gran tamaño.
