...
- Rich blocks (code, table, mermaid) keep a `my-[1.1em]` vertical rhythm against surrounding prose, bumped to `mt-[0.9em]` when directly following a heading or paragraph.
