...
> 💡 **[Вышла Open Science v0.23.0](https://github.com/aipoch/open-science/releases/latest)** _(последнее обновление: август 2026 г.)_. Open Science v0.23.0 позволяет агенту читать те же статьи, что читаете вы: к сессии можно привязать до трёх PDF в качестве контекста для чтения, агент может читать их, листать и искать по ним, а выделенный текст или область добавляется как свидетельство с переходом по клику к месту в исходном документе — вместе с живыми подсказками имён переменных ядра и закреплённой панелью «Переменные» в Notebook, подписками Tencent Coding Plan и Token Plan, кэшами рабочих нагрузок Notebook, которые следуют за настроенным расположением хранилища, и большим набором исправлений целостности хранилища, удалённого доступа и учётных данных. Полный список изменений приведён в [примечаниях к последнему выпуску](https://github.com/aipoch/open-science/releases/latest).
