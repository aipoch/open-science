...
> 💡 **[Вышла AIPOCH Open-Science v0.31.0](https://github.com/aipoch/open-science/releases/latest)** _(последнее обновление: сентябрь 2026 г.)_. AIPOCH Open-Science v0.31.0 позволяет форкать доступную для записи сессию с полной историей исследования — ветвями диалога, записями Notebook, артефактами, литературой и закладками, — при этом импортированные сессии остаются доступными только для чтения. Название продукта теперь унифицировано как Open-Science: существующие установки и все данные исследований сохраняются. Планы сессий восстанавливают свой контекст после реконструкции агента, подключения провайдеров проверяются перед сохранением, коннектор gnomAD может возвращать частоты на уровне популяций, а ветвящиеся сессии показывают разделитель продолжения к исходной сессии. R в Windows снова работает в стандартном режиме без настройки защищённого режима, а коннекторы, диалоги и обработка разрешений доработаны по всем направлениям. Полный список изменений приведён в [примечаниях к последнему выпуску](https://github.com/aipoch/open-science/releases/latest).
