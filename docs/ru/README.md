...
> 💡 **[Вышла Open Science v0.20.2](https://github.com/aipoch/open-science/releases/latest)** _(последнее обновление: август 2026 г.)_. Open Science v0.20.2 добавляет полноценный испанский интерфейс, безопасный встроенный предпросмотр ссылок на источники в ответах агента, живой браузер переменных для запущенных ядер ноутбуков, всплывающие предпросмотры сессий в боковой панели, контекстное меню правого клика для вкладок предпросмотра, а также провайдеров OpenCode Go и Zen и модели семейства GLM-5.3; вместе с этим — более быстрый рендеринг бесед, ограничение частоты сохранения долгих сессий и исправления персистентности сессий, предпросмотра планов, архивации и ноутбуков. Полный список изменений приведён в [примечаниях к последнему выпуску](https://github.com/aipoch/open-science/releases/latest).
