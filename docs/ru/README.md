...
> 💡 **[Вышла Open Science v0.20.1](https://github.com/aipoch/open-science/releases/latest)** _(последнее обновление: август 2026 г.)_. Open Science v0.20.1 добавляет генерируемые и редактируемые сведения о сессии (заголовок и описание), сочетание клавиш для повтора правки черновика в композере, импорт/экспорт клиентских конфигураций MCP с подстановкой учётных данных, подробности использования по каждому вызову модели с обновлённым графиком окна контекста по вызовам и коррелированные диагностики HTTP-запросов; вместе с этим — работа сети в согласии с настройками прокси, проверенные загрузки, усиленное сопряжение удалённого доступа и большой список исправлений сессий, ноутбуков, коннекторов, вычислений и провайдеров. Полный список изменений приведён в [примечаниях к последнему выпуску](https://github.com/aipoch/open-science/releases/latest).
...
| **Распространение и поддержка** | Установщики для macOS, Windows и Linux; упрощённый мастер первоначальной настройки среды, агента, поставщика модели, Notebook и расположения данных; интерфейс на испанском, французском, упрощённом и традиционном китайском, японском, корейском и русском языках; README для каждого поддерживаемого языка; дополнительные многоязычные руководства для участников; заметные напоминания и инструкции по обновлению; локальная диагностика; ссылки на сообщество.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
