...
> 💡 **[Вышла AIPOCH Open-Science v0.33.0](https://github.com/aipoch/open-science/releases/latest)** _(последнее обновление: сентябрь 2026 г.)_. AIPOCH Open-Science v0.33.0 приносит скрининг литературы исследовательского уровня: умные подборки Literature оценивают библиографические записи по вашим критериям включения и исключения, со статусами «Включено» / «Требует проверки» / «Исключено», доказательствами PDF и автоматическим обновлением по явному выбору. Исследовательские пакеты теперь содержат метаданные RO-Crate (для вновь экспортируемых пакетов нужен читатель с поддержкой ro-crate; существующие остаются читаемыми), а семейство коннекторов пополняют поиск публичных записей Zenodo, метаданные проектов и файлов GDC и пакетное сопоставление идентификаторов UniProt. Управление доступом к ресурсам по агентам собирает разрешения на навыки и коннекторы главного агента и специалистов в одном месте, сессии получают локальный экспорт диагностики, а каталоги поставщиков обновляются моделями Xiaomi MiMo v2.6, Grok 4.7 и моделями текущего поколения в Zen и Go. Оповещения Notebook о среде и восстановлении стали закрываемыми, средство сброса пакета Windows снимает атрибуты «только чтение», пакеты Linux поставляют движок запросов Fedora, а потоковая передача остаётся отзывчивой благодаря ограниченной оценке токенов. Подробнее см. в [примечаниях к последнему выпуску](https://github.com/aipoch/open-science/releases/latest).
