...
> 💡 **[Вышла Open Science v0.24.0](https://github.com/aipoch/open-science/releases/latest)** _(последнее обновление: август 2026 г.)_. Open Science v0.24.0 делает переход между проектами быстрее, а выполнение кода безопаснее: быстрый переключатель проектов в меню рабочего пространства, сетевой доступ Notebook и вычислительных сред, ограниченный одобренными вами доменами с подтверждением новых прямо в диалоге (в Windows — после однократной настройки песочницы с правами администратора), общие для устройства учётные данные, к которым могут привязываться пользовательские коннекторы, безопасные разрешения по умолчанию с восстановлением в одно нажатие и интерфейс на немецком языке — вместе с неизменяемыми поколениями файлов для запусков Notebook и вычислений, укреплёнными удалёнными вычислительными заданиями и широким набором исправлений среды выполнения, коннекторов и хранилища. Полный список изменений приведён в [примечаниях к последнему выпуску](https://github.com/aipoch/open-science/releases/latest).
...
| **Распространение и поддержка** | Установщики для macOS, Windows и Linux; упрощённый мастер первоначальной настройки среды, расположения данных, агента, поставщика модели и Notebook; интерфейс на немецком, испанском, французском, упрощённом и традиционном китайском, японском, корейском, бразильском португальском и русском языках; README для каждого поддерживаемого языка; дополнительные многоязычные руководства для участников; заметные напоминания и инструкции по обновлению; локальная диагностика; ссылки на сообщество.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
