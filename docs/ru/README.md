...
<p align="center">
  ...
  <a href="../pt-BR/README.md"><img alt="README на бразильском португальском" src="https://img.shields.io/badge/Português%20(Brasil)-d9d9d9"></a>
...
> 💡 **[Вышла Open Science v0.21.0](https://github.com/aipoch/open-science/releases/latest)** _(последнее обновление: август 2026 г.)_. Open Science v0.21.0 добавляет CodeBuddy как четвёртый фреймворк агента (управляемый приложением, без входа в систему), аннотации текста и изображений, отправляющие выделенный фрагмент как контекст агенту, существенно расширенные каталоги моделей OpenCode Go и Zen, SSH-аутентификацию по паролю на Windows для удалённых вычислений, маркеры изменения конфигурации агента в хронологии беседы, а также обновлённые центр сообщений уведомлений и маркетплейс специалистов; вместе с этим — ужесточение разрешений рендерера, обработка тайм-аутов коннекторов и большой список исправлений вычислений, ноутбуков, сессий и рабочего пространства. Полный список изменений приведён в [примечаниях к последнему выпуску](https://github.com/aipoch/open-science/releases/latest).
...
| **Распространение и поддержка** | Установщики для macOS, Windows и Linux; упрощённый мастер первоначальной настройки среды, агента, поставщика модели, Notebook и расположения данных; интерфейс на испанском, французском, упрощённом и традиционном китайском, японском, корейском, бразильском португальском и русском языках; README для каждого поддерживаемого языка; дополнительные многоязычные руководства для участников; заметные напоминания и инструкции по обновлению; локальная диагностика; ссылки на сообщество.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
