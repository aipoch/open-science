...
> 💡 **[Вышла Open Science v0.26.0](https://github.com/aipoch/open-science/releases/latest)** _(последнее обновление: сентябрь 2026 г.)_. Open Science v0.26.0 приносит вычисления уровня HPC и рабочее пространство для литературы: удалённые вычислительные узлы получают режим выполнения Slurm для каждого узла наряду с прямым подключением по SSH, а новая библиотека источников упорядочивает библиографические записи, PDF и цитаты — с импортом по идентификаторам, объединением дубликатов, прикреплением полных текстов из открытого доступа и оформлением цитат. Apodex присоединяется к встроенным поставщикам вместе с новейшими моделями OpenAI и Anthropic, вызовы инструментов Notebook становятся читаемыми сводными карточками, а по всему приложению появляются более плавная потоковая передача, менее навязчивые разрешения по умолчанию и широкий набор исправлений. Полный список изменений приведён в [примечаниях к последнему выпуску](https://github.com/aipoch/open-science/releases/latest).
...
В Open Science входит растущий каталог из **22 рекомендуемых** файловых исследовательских навыков: AlphaFold2, Boltz, Borzoi, Chai-1, Customize, DiffDock, Environment & Packages, ESM-2, ESMFold2, Evo 2, Figure Composer, Figure Style, Indication Dossier, LigandMPNN, Literature Review, OpenFold3, Paper Narrative, ProteinMPNN, scGPT, scvi-tools, SolubleMPNN и **Remote Compute (SSH)** для отправки длительных заданий на удалённые кластеры HPC и получения результатов. Можно создавать личные навыки, загружать пакеты `SKILL.md`, ZIP и `.skill`, просматривать и импортировать совместимые навыки из GitHub с необязательной аутентификацией или импортировать навыки, уже установленные в глобальных каталогах агентов. Агент также может запросить импорт пакета из вложения сессии или общедоступного URL GitHub; прежде чем что-либо будет записано, приложение покажет собственный предпросмотр и запросит подтверждение. Включённый навык можно выбрать непосредственно в поле ввода с помощью `/`.
...
Open Science объединяет чаты, Notebook, локальные скрипты, научные базы данных, файлы и средства подготовки отчётов в едином постоянном локальном рабочем пространстве для исследований с ИИ, где выполнение остаётся связанным с доказательствами.
...
[AIPOCH](https://aipoch.com/) разрабатывает [Open Science](https://aipoch.com/open-science) — локальную настольную исследовательскую среду с открытым исходным кодом для научных процессов с ИИ.
...
| --------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Проекты и сессии**                                            | Создавайте и организуйте проекты с закреплёнными сессиями, постоянными ветвями сообщений и боковыми обсуждениями, редактируемыми сведениями о сессии, а также восстановлением недавней работы, черновиков, истории обсуждений и состояния предварительного просмотра.                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
