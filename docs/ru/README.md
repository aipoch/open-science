...
> 💡 **[Вышла Open Science v0.22.0](https://github.com/aipoch/open-science/releases/latest)** _(последнее обновление: август 2026 г.)_. Open Science v0.22.0 добавляет постоянную память агента, переносящую знания между сессиями, процессы подготовки рисунков с учётом происхождения во встроенных навыках, централизованное управление учётными данными для токенов GitHub и входов коннекторов, а также более полную панель использования, которая привязывает расход токенов к породившим их запускам и учитывает вспомогательные вызовы моделей; вместе с этим — провайдер моделей Tencent TokenHub, укреплённые загрузка обновлений и установка рантаймов и большой список исправлений сессий, бэкенда Claude и локального localhost-сервиса. Полный список изменений приведён в [примечаниях к последнему выпуску](https://github.com/aipoch/open-science/releases/latest).
