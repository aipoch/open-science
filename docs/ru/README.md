...
> 💡 **[Вышла AIPOCH Open-Science v0.33.3](https://github.com/aipoch/open-science/releases/latest)** _(обновлено в сентябре 2026)_. AIPOCH Open-Science v0.33.3 улучшает предпросмотр документов: постраничное чтение документов Office с поиском и постраничный просмотр PowerPoint, добавляет инструменты обогащения генных наборов Enrichr в коннектор генов и приносит компактный предпросмотр библиотеки в рабочую область. Подпись Windows теперь покрывает все поставляемые исполняемые файлы, скрининг Literature получает действие «отменённая оценка», а пакеты сессий могут передаваться с адаптивной скоростью. Подробности — в [последних заметках о выпуске](https://github.com/aipoch/open-science/releases/latest).
