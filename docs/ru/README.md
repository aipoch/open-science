...
> 💡 **[Вышла Open Science v0.18.1](https://github.com/aipoch/open-science/releases/latest)** _(последнее обновление: август 2026 г.)_. В Open Science v0.18.1 появилась возможность обнаруживать вычислительные узлы в рамках сессии и выбирать узлы для выполнения заданий, в том числе через CLI; обновлённое уведомление об ошибке при запуске приложения; улучшенные оповещения центра сообщений с контекстом проекта и задачи; сворачивание длинных сообщений пользователя; первичная проверка без обязательных замечаний; французская локализация; групповое меню импортированных навыков; команды CLI для обновления приложения и настройки контекста агента проекта. Также благодаря кэшированию панелей и повторному использованию проверок сред выполнения ускорены настройки и запуск, согласуются параллельные изменения сообщений и веток, фиксируется происхождение артефактов коннекторов, усилены ограничения локального HTTP-интерфейса и добавлены рекомендации по восстановлению после сбоев обновления. Полный список изменений приведён в [примечаниях к последнему выпуску](https://github.com/aipoch/open-science/releases/latest).
...
2. **Среда выполнения агента** — выбор и подготовка Claude Code, OpenCode или Codex. Управляемые приложением среды можно установить без Node.js, npm и пароля администратора.
3. **Поставщик моделей** — подключение и проверка нужной модели. Можно выбрать встроенного поставщика, собственный шлюз или существующую подписку Claude либо Codex.
4. **Среда выполнения Notebook** — необязательная подготовка управляемых приложением сред Python и R либо подключение обнаруженных или вручную зарегистрированных интерпретаторов.
5. **Расположение данных** — выбор папки для крупных артефактов, Notebook, загруженных файлов и сред выполнения.
