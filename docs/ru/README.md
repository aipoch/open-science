...
Open Science — открытая локальная рабочая среда с ИИ для учёных и исследователей. Она помогает вести воспроизводимые и прозрачные исследования с разными моделями, научными ИИ-агентами, выполнением кода на Python и R, коннекторами научных данных и поддержкой macOS, Windows и Linux. Создайте проект, опишите исследовательскую задачу обычным языком, и агенты смогут читать файлы, искать информацию в интернете, выполнять код, обращаться к научным источникам данных и готовить отчёты, таблицы и графики с прослеживаемым происхождением — всё в одном рабочем пространстве.
