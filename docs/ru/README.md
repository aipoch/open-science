...
> 💡 **[Вышла Open Science v0.18.2](https://github.com/aipoch/open-science/releases/latest)** _(последнее обновление: август 2026 г.)_. Open Science v0.18.2 добавляет русскую локализацию, выбор ходов для экспорта бесед в Markdown и PDF, а также предварительно зарегистрированные OAuth-клиенты для пользовательских коннекторов с зашифрованным хранением секретов и привязкой к издателю. Ограниченный приём событий и потоковый экспорт ZIP-архивов артефактов проекта сохраняют отзывчивость рабочей области при высокой нагрузке, а выполнение в Notebook получает сигналы прогресса и декодирование исходного кода в UTF-8. Вложения теперь сохраняются при редактировании сообщений, непрозрачные сбои возобновления Codex восстанавливаются, повторные запросы Task API идемпотентны, а также исправлен ряд проблем рабочей области, обновлений и сохранности данных. Полный список изменений приведён в [примечаниях к последнему выпуску](https://github.com/aipoch/open-science/releases/latest).
...
| **Модели**                      | Встроенные облачные поставщики, совместимые пользовательские шлюзы, вход по подписке Claude и Codex, проверка соединения, мультимодальный ввод изображений для отдельных моделей, единый выбор модели и поддерживаемой глубины рассуждений для каждой сессии, значения по умолчанию из настроек только для новых сессий, отдельная модель Vision с устойчивой передачей данных изображений для текстовых сред. Доступные поставщики и форматы API проверяются с учётом выбранной среды агента.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
