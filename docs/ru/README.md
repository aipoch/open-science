...
> 💡 **[Вышла Open Science v0.18.0](https://github.com/aipoch/open-science/releases/latest)** _(последнее обновление: август 2026 г.)_. В Open Science v0.18.0 появились общие для разных типов ресурсов теги, включая «Избранное» и сортировку перетаскиванием, обновлённое управление навыками и более быстрый маркетплейс специалистов: каталог открывается из кэша без задержки, появились значки возможностей и быстрое редактирование оформления. Вычислительные узлы теперь поддерживают вход по паролю SSH с шифрованием учётных данных средствами ОС. Корейская локализация, а также многоязычные README и руководства для участников сделали проект доступнее. Кроме того, улучшены загрузка маркетплейса и коннекторов, потоковая передача событий среды выполнения, защищённое удаление, атомарное сохранение первоначальной настройки и восстановление после сбоев при запуске, в сессиях, вычислениях и обновлениях. Полный список изменений приведён в [примечаниях к последнему выпуску](https://github.com/aipoch/open-science/releases/latest).
