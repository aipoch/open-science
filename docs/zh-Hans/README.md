...
| **文献**         | 开箱即用的项目级文献库：按标识符（DOI、PubMed ID、arXiv ID 等）或从文件导入参考文献，整理进合集并关联到项目，下载的 PDF 会经由收件箱流转，并支持从回收站恢复；通过公开的开放获取来源（Europe PMC、PMC、OpenAlex、arXiv 和 Unpaywall）查找并附加全文 PDF，并行查询所有适用的来源，可选用凭据；并排比较重复题录并批量合并，同时保留附件与关联；以及基于已存储的元数据格式化引用并附带产物来源。                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
