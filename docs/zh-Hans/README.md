...
> 💡 **[Open Science v0.22.0 已发布](https://github.com/aipoch/open-science/releases/latest)** _（最后更新于 2026 年 8 月）_。Open Science v0.22.0 新增可跨会话承载知识的持久智能体记忆、内置技能中的来源感知图形工作流、GitHub 令牌与连接器登录的集中凭据管理，以及更完整的用量仪表盘——将词元用量归因到产生它的运行，并统计辅助模型调用；同时提供 Tencent TokenHub 模型服务商、更安全的更新下载与运行时安装，并修复大量会话、Claude 后端与本地服务问题。详情请查看[最新发行说明](https://github.com/aipoch/open-science/releases/latest)。
...
| **本地数据管理** | 本地项目和应用数据、可配置存储位置、引导式迁移，以及带系统、手动和直连模式的全局代理设置；词元用量仪表板包含周期汇总、30 天活动热力图、每日输入/缓存/输出图表、逐运行用量归因，以及对主对话之外模型调用的覆盖（侧边对话、委派与上下文压缩）。                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
...
| **安全控制**     | `Ask for approval`、`Auto-approve edits` 和 `Full access` 对话配置；包含代码预览以及调用/对话决定的批准对话框；在当前回合持续生效的权限拒绝，阻止智能体通过其他路径重试或变相执行被拒绝的操作；持久化的全局、项目和会话级允许授权，支持筛选、逐行和按系列撤销以及撤销操作；针对 GitHub 令牌、连接器密钥与连接器登录的集中凭据管理，提供健康状态与引导式恢复；另有逐连接器和逐工具策略。                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
...
当前内置云厂商包括 OpenAI、Anthropic、Grok (xAI)、DeepSeek、带专用 GLM Coding Plan 端点的智谱 AI (GLM)、Kimi (Moonshot)、MiniMax、带专用 Step Plan 订阅端点的 StepFun、小米 MIMO、SenseNova、Volcengine Ark、带专用 Bailian for Plan 订阅端点的百炼 (Alibaba Cloud)、Tencent TokenHub，以及 OpenCode Go、OpenCode Zen 和 OpenRouter 聚合网关等；部分具有地区限制。
