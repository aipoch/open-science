...
> 💡 **[Open Science v0.23.0 已发布](https://github.com/aipoch/open-science/releases/latest)** _（最后更新于 2026 年 8 月）_。Open Science v0.23.0 让智能体阅读你正在阅读的论文：最多可将三个 PDF 关联到会话作为阅读上下文，让智能体阅读、逐页浏览并检索它们，并将文本或区域高亮为证据、在源文档中点击即可定位——同时提供 Notebook 中实时的内核变量建议与停靠式变量面板、腾讯 Coding Plan 与 Token Plan 订阅、随所配置存储位置一同迁移的 Notebook 工作负载缓存，以及一大批存储完整性、远程访问与凭据修复。详情请查看[最新发行说明](https://github.com/aipoch/open-science/releases/latest)。
...
| **分发与支持**   | macOS、Windows 和 Linux 安装程序；针对环境、数据位置、智能体运行时、模型服务商和 Notebook 运行时的精简首次启动向导；支持西班牙语、法语、简体中文、繁体中文、日语、韩语、巴西葡萄牙语和俄语界面，为每种受支持语言提供 README 译本，并另有多语言贡献指南；带醒目更新提醒的更新指引；本地诊断；社区链接。                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
