...
> 💡 **[Open Science v0.23.0 출시](https://github.com/aipoch/open-science/releases/latest)** _(마지막 업데이트: 2026년 8월)_. Open Science v0.23.0은 에이전트가 사용자가 읽는 논문을 함께 읽을 수 있게 합니다. 세션에 최대 세 개의 PDF를 읽기 컨텍스트로 연결해 에이전트가 읽고 페이지를 넘기고 검색하게 하고, 텍스트나 영역을 하이라이트하면 출처 문서에서 클릭해 바로 확인할 수 있는 증거가 됩니다. 이와 함께 Notebook의 실시간 커널 변수 제안과 도킹된 Variables 패널, Tencent Coding Plan 및 Token Plan 구독, 구성된 저장 위치를 따르는 Notebook 워크로드 캐시, 그리고 저장소 무결성·원격 액세스·자격 증명에 관한 폭넓은 문제 수정이 포함됩니다. 자세한 내용은 [최신 릴리스 노트](https://github.com/aipoch/open-science/releases/latest)를 확인하세요.
...
| **배포 및 지원**      | macOS, Windows, Linux 설치 프로그램, 환경·데이터 위치·에이전트 런타임·모델 제공업체·Notebook 런타임을 위한 간결한 최초 실행 마법사, 스페인어·프랑스어·중국어 간체·중국어 번체·일본어·한국어·브라질 포르투갈어·러시아어 인터페이스, 지원 언어별 README 번역, 그 밖의 다국어 기여 가이드, 눈에 띄는 업데이트 알림이 포함된 업데이트 안내, 로컬 진단, 커뮤니티 링크.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
