...
| **문헌**              | 프로젝트에 바로 쓸 수 있는 참고문헌 라이브러리. 식별자(DOI, PubMed ID, arXiv ID 등)나 파일로 참고문헌을 가져오고, 컬렉션으로 정리하고, 프로젝트에 연결하고, 다운로드한 PDF는 휴지통 복구가 있는 받은 편지함으로 전달합니다. 자격 증명을 선택적으로 사용해 공개 오픈 액세스 소스(Europe PMC, PMC, OpenAlex, Unpaywall)에서 전문 PDF를 찾아 첨부합니다. 중복 문헌을 나란히 비교하고 첨부 파일과 연결을 유지한 채 일괄 병합합니다. 그리고 저장된 메타데이터에서 아티팩트 출처와 함께 인용 형식을 지정합니다.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
