...
> 💡 **[AIPOCH Open-Science v0.31.0 veröffentlicht](https://github.com/aipoch/open-science/releases/latest)** _(zuletzt aktualisiert im September 2026)_. AIPOCH Open-Science v0.31.0 ermöglicht das Forken einer beschreibbaren Sitzung mit vollständiger Forschungshistorie — Konversationsverzweigungen, Notebook-Einträge, Artefakte, Literatur und Lesezeichen —, während importierte Sitzungen schreibgeschützt bleiben. Der Produktname wird jetzt durchgängig als Open-Science geführt; bestehende Installationen und alle Forschungsdaten bleiben unverändert erhalten. Sitzungspläne stellen ihren Kontext nach der Kontextrekonstruktion des Agenten wieder her, Provider-Verbindungen werden vor dem Speichern validiert, der gnomAD-Konnektor kann Frequenzen auf Populationsebene ausgeben, und verzweigte Sitzungen zeigen eine Fortsetzungslinie zurück zur Quelle. R unter Windows läuft ohne Einrichtung des geschützten Modus im Standardmodus, und Konnektoren, Dialoge und die Berechtigungsbehandlung wurden durchgehend präzisiert. Weitere Details finden Sie in den [neuesten Versionshinweisen](https://github.com/aipoch/open-science/releases/latest).
