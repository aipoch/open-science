...
> 💡 **[AIPOCH Open-Science v0.33.1 veröffentlicht](https://github.com/aipoch/open-science/releases/latest)** _(zuletzt aktualisiert September 2026)_. AIPOCH Open-Science v0.33.1 bringt Live-Screening für smarte Literature-Sammlungen mit Pause und Fortsetzen, drei neue Forschungs-Connectors – HMMER-Sequenzsuche, InterProScan-Domänenannotation und Clustal-Omega-Multiple-Sequence-Alignment – sowie GPT-6 und Claude Opus 5.5 in den Anbieterkatalogen. PDF-Nachweise können jetzt mit der ersten Nachricht eines Workspace-Gesprächs übermittelt werden, und Sitzungsdiagnosen können auf Wunsch vertrauliche Paketnachweise enthalten. Windows-verwaltete Python-Laufzeiten wurden wiederhergestellt, Speicherkonflikte in Notebook und Compute werden sauber aufgelöst, und die Agenten-Brücke baut sich bei geänderten Vision-Fähigkeiten neu auf. Details finden Sie in den [neuesten Release Notes](https://github.com/aipoch/open-science/releases/latest).
