...
> 💡 **[Open Science v0.20.2 veröffentlicht](https://github.com/aipoch/open-science/releases/latest)** _(zuletzt aktualisiert im August 2026)_. Open Science v0.20.2 bietet eine vollständig spanische Benutzeroberfläche, abgeschirmte Quellenvorschauen für Links in Agentenantworten direkt in der App, eine Live-Variablenansicht für laufende Notebook-Kernel, Sitzungsvorschauen in der Seitenleiste, Kontextaktionen für Vorschau-Tabs sowie die neuen Anbieter OpenCode Go und OpenCode Zen und Modelle der GLM-5.3-Familie. Hinzu kommen schnelleres Rendering von Konversationen, kontrolliertes Speichern lang laufender Sitzungen und Korrekturen an Sitzungspersistenz, Planvorschau, Archivierung und Notebooks. Einzelheiten finden Sie in den [neuesten Versionshinweisen](https://github.com/aipoch/open-science/releases/latest).
