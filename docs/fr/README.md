...
> 💡 **[AIPOCH Open-Science v0.30.2 est disponible](https://github.com/aipoch/open-science/releases/latest)** _(dernière mise à jour : septembre 2026)_. AIPOCH Open-Science v0.30.2 est une version de stabilité : les environnements d'exécution R sous Windows se rétablissent de manière fiable (démarrage conda, résolution de l'exécutable, récupération des noyaux et points d'entrée pip vérifiés), les entrées Notebook d'un même tour se rejouent correctement, et les corrections du réviseur conservent leur contexte à travers les retours liés. Les imports de littérature séparent les noms de famille des auteurs PubMed de leurs initiales et détectent les relations de rétractation, les connecteurs resserrent le comportement d'Ensembl, VEP, Reactome, UCSC et gnomAD, et DeepSeek V4.1 Flash rejoint le catalogue de modèles. Consultez les [notes de version les plus récentes](https://github.com/aipoch/open-science/releases/latest) pour tous les détails.
...
| ------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Projets et sessions**                                             | Créez et organisez des projets avec des sessions épinglées, des branches de messages et conversations latérales persistantes, et des détails de session modifiables. Modifiez les prompts terminés en branches de messages persistantes et sélectionnables sans supprimer le chemin aval d’origine, puis restaurez les travaux récents, brouillons, historiques de conversation et états d’aperçu. Les conversations latérales s’ouvrent en onglets d’aperçu indépendants — exécutez-en plusieurs aux côtés de la conversation principale, qui reste interactive, démarrez-les en brouillons qui héritent du modèle actuel, et déplacez les annotations entre elles. Exportez une session sous forme de paquet de recherche `.science` autonome et importez-la dans un autre projet ou sur une autre machine — avec les branches de conversation, les versions de fichiers, les enregistrements Notebook et les preuves de vérification qui font le voyage.                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| **Workflow d’agent**                                                | Les sessions en langage naturel fournissent des réponses en continu et une activité des outils regroupée par objectif, avec contrôles d’approbation et d’arrêt, suivis en file d’attente, compactage du contexte et récupération après redémarrage. Dérivez un travail terminé dans de nouvelles sessions et utilisez des clarifications structurées, des annotations de texte, d’image et de PDF, le contexte de lecture des PDF liés, la mémoire de projet, les références de session, des plans soumis à révision, et des signets privés avec notes sur le texte de conversation, les aperçus et les passages de PDF, qui survivent aux redémarrages. Une recherche globale catégorisée atteint les projets, les sessions, les corps de messages, les fichiers téléversés et générés, et la bibliothèque de littérature, avec des filtres standard et avancés et des aperçus de détail contextuels qui mènent directement au message correspondant. Les notifications, l’état en direct, les détails de durée et de jetons, la palette de commandes, les aperçus des sources et le changement de projet rendent les recherches longues visibles et maîtrisables.                                                                                                                                                                                                                                                                |
| **Modèles et backends d’agents**                                    | Utilisez les fournisseurs cloud intégrés, notamment Apodex, NVIDIA Build avec un catalogue sélectionné de modèles compatibles avec les agents, ainsi que les derniers catalogues de modèles OpenAI et Anthropic (GPT-6 Astra et Claude Fable 5.1), des passerelles personnalisées compatibles ou les connexions par abonnement Claude et Codex. Sélectionnez Claude Code, OpenCode, Codex ou l’environnement CodeBuddy sans connexion comme backend d’agent, avec validation de la compatibilité des modèles et API, entrée d’images multimodale, contrôle du niveau de raisonnement et politiques dédiées au sous-agent, au réviseur et à Vision. Les environnements d’exécution gérés par l’application se mettent à jour sur place — le CLI Codex géré propose des mises à niveau testées depuis Paramètres, avec les versions du CLI et de l’adaptateur affichées séparément.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
...
| **Artefacts et provenance**                                         | Conservez des versions immuables d’artefacts propres à chaque session avec contenu contrôlé par somme, code producteur, historique d’exécution, entrées exactes, inventaire d’environnement, contexte de branche de messages, filiation et preuves de révision. À chaque enregistrement, les fichiers Markdown, textes, scripts et codes source modifiables publient une nouvelle version préservant la provenance et comparable à la précédente. Vérifiez toute version capturée en rejouant sa recette scellée dans un environnement isolé et en comparant les fichiers reproduits avec l’original — contrôles exacts à l’octet près, comparaisons bornées d’images et de tableaux, règles scientifiques optionnelles et enregistrements de vérification exportables.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| **Compétences scientifiques et connecteurs de données**             | Étendez les workflows de recherche avec **22 compétences intégrées mises en avant** et **24 connecteurs de recherche intégrés**. Créez des compétences par conversation ou à partir d’un travail terminé, importez des paquets et sources GitHub et ajoutez des connecteurs MCP locaux ou distants personnalisés avec autorisations par outil et import/export de configuration. Parcourez la place de marché vérifiée de compétences via des catalogues signés — découvrez des compétences par catégorie et par auteur avec installation en un clic, mises à jour de version et installation par lots avec sélection filtrée et progression avec reprise en cas d’échec — et gérez les connecteurs en masse depuis Paramètres. Les compétences applicatives principales restent toujours activées afin que les points d’entrée intégrés continuent de fonctionner, et le CLI headless et le Task SDK peuvent lister, inspecter, activer ou désactiver des connecteurs. Des étiquettes transversales, une étiquette Favoris protégée et des filtres consultables organisent compétences, connecteurs et spécialistes.                                                                                                                                                                                                                                                                                                              |
| **Données locales, confidentialité, autorisations et vérification** | Conservez localement les données de projet, l’état de l’application et les caches de Notebook dans un stockage configurable et migrable ; utilisez les modes proxy système, manuel ou direct et un tableau de bord des jetons avec carte thermique d’activité sur 30 jours et attribution par exécution. Contrôlez les actions avec `Ask for approval`, `Auto-approve edits` ou `Full access`, des autorisations limitées, des identifiants centralisés (avec un mode de stockage fichier explicite pour les déploiements Linux headless), des domaines de calcul approuvés par l’utilisateur et des politiques par connecteur et outil. Les médias distants dans la sortie des modèles ne se chargent qu’après une activation explicite, les images envoyées aux modèles sont normalisées, et les points de terminaison de modèles distants doivent utiliser HTTPS. Un réviseur facultatif audite les transcriptions, journaux d’exécution et artefacts, signale les résultats réussite/avertissement/échec et peut exécuter une boucle de correction limitée avec preuves durables.                                                                                                                                                                                                                                                                                                                                              |
