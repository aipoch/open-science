...
> 💡 **[Open Science v0.18.2 est disponible](https://github.com/aipoch/open-science/releases/latest)** _(dernière mise à jour : août 2026)_. Open Science v0.18.2 ajoute la localisation russe, la sélection des tours pour l'export des conversations en Markdown et PDF, ainsi que des clients OAuth préenregistrés pour les connecteurs personnalisés, avec stockage chiffré des secrets et verrouillage de l'émetteur. L'admission bornée des événements et l'export en continu des archives ZIP d'artefacts de projet préservent la réactivité des espaces de travail chargés, tandis que les exécutions Notebook bénéficient de signaux de progression et du décodage UTF-8 du code source. Les pièces jointes sont désormais conservées lors de la modification des messages, les échecs opaques de reprise Codex sont récupérés, les nouvelles tentatives de l'API Task sont idempotentes, et plusieurs problèmes liés à l'espace de travail, aux mises à jour et à la persistance sont corrigés. Consultez les [notes de version les plus récentes](https://github.com/aipoch/open-science/releases/latest) pour tous les détails.
...
| **Modèles**                    | Fournisseurs cloud intégrés, passerelles compatibles personnalisées, connexions par abonnement Claude et Codex, validation de connexion, entrée d'images multimodale par modèle, sélecteur combiné du composeur par session pour le modèle et l'effort de raisonnement qu'il prend en charge, valeurs par défaut des Paramètres pour les nouvelles sessions, et sélecteur Vision dédié avec relais d'évidence d'image persistant pour les backends texte uniquement. Les fournisseurs disponibles et les formats d'API sont validés contre le backend d'agent sélectionné.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
