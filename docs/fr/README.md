...
> 💡 **[AIPOCH Open-Science v0.33.3 est disponible](https://github.com/aipoch/open-science/releases/latest)** _(dernière mise à jour en septembre 2026)_. AIPOCH Open-Science v0.33.3 fait évoluer l'aperçu des documents avec une lecture Office paginée et une recherche, ainsi qu'une revue PowerPoint page par page, ajoute des outils d'enrichissement de gènes Enrichr au connecteur de gènes et apporte un aperçu compact de la bibliothèque à l'espace de travail. La signature Windows couvre désormais tous les exécutables fournis, le criblage de Literature gagne une action d'abandon d'évaluation, et les paquets de session peuvent se transférer à des vitesses adaptatives. Voir les [notes de version](https://github.com/aipoch/open-science/releases/latest) pour tous les détails.
