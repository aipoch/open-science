...
> 💡 **[Open Science v0.20.2 est disponible](https://github.com/aipoch/open-science/releases/latest)** _(dernière mise à jour : août 2026)_. Open Science v0.20.2 ajoute une interface complète en espagnol, l'aperçu sécurisé dans l'application des liens sources des réponses de l'agent, un navigateur de variables en direct pour les noyaux de notebook en cours d'exécution, des aperçus au survol des sessions dans la barre latérale, un menu contextuel par clic droit sur les onglets d'aperçu, ainsi que les fournisseurs OpenCode Go et Zen et les modèles de la famille GLM-5.3 ; en parallèle, un rendu de conversation plus rapide, une fréquence de sauvegarde bornée pour les sessions longues, et des correctifs de persistance de session, d'aperçu de plan, d'archivage et de notebook. Consultez les [notes de version les plus récentes](https://github.com/aipoch/open-science/releases/latest) pour tous les détails.
