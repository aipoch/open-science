...
> 💡 **[Open Science v0.26.0 est disponible](https://github.com/aipoch/open-science/releases/latest)** _(dernière mise à jour : septembre 2026)_. Open Science v0.26.0 apporte un calcul de classe HPC et un espace de travail dédié à la littérature : les hôtes de calcul distants gagnent un mode d'exécution Slurm par hôte en complément de SSH direct, et une nouvelle bibliothèque de références organise les références, les PDF et les citations avec des imports par identifiant, la fusion des doublons, la récupération de pièces jointes en texte intégral en libre accès et la mise en forme des citations. Apodex rejoint les fournisseurs intégrés aux côtés des derniers modèles OpenAI et Anthropic, les appels d'outils des notebooks deviennent des cartes de synthèse lisibles, et un flux plus fluide, des autorisations par défaut plus discrètes et un large ensemble de correctifs arrivent dans l'ensemble de la version. Consultez les [notes de version les plus récentes](https://github.com/aipoch/open-science/releases/latest) pour tous les détails.
...
Open Science réunit les échanges, les Notebooks, les scripts, les bases de données scientifiques, les fichiers et les outils de reporting dans un banc de travail de recherche IA persistant et local-first où l'exécution reste liée aux preuves.
...
[AIPOCH](https://aipoch.com/) développe [Open Science](https://aipoch.com/open-science), un banc de travail de recherche de bureau open source et local-first pour les workflows d'IA scientifique.
...
| ------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Projets et sessions**                                             | Créez et organisez des projets avec des sessions épinglées, des branches de messages et conversations latérales persistantes, des détails de session modifiables, ainsi que la restauration des travaux récents, brouillons, historiques de conversation et états d’aperçu.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
...
| **Compétences scientifiques et connecteurs de données**             | Étendez les workflows de recherche avec **22 compétences intégrées mises en avant** et **24 connecteurs de recherche intégrés**. Créez des compétences par conversation ou à partir d’un travail terminé, importez des paquets et sources GitHub et ajoutez des connecteurs MCP locaux ou distants personnalisés avec autorisations par outil et import/export de configuration. Des étiquettes transversales, une étiquette Favoris protégée et des filtres consultables organisent compétences, connecteurs et spécialistes.                                                                                                                                                                                                                                          |
| **Données locales, confidentialité, autorisations et vérification** | Conservez localement les données de projet, l’état de l’application et les caches de Notebook dans un stockage configurable et migrable ; utilisez les modes proxy système, manuel ou direct et un tableau de bord des jetons avec carte thermique d’activité sur 30 jours et attribution par exécution. Contrôlez les actions avec `Ask for approval`, `Auto-approve edits` ou `Full access`, des autorisations limitées, des identifiants centralisés, des domaines de calcul approuvés par l’utilisateur et des politiques par connecteur et outil. Un réviseur facultatif audite les transcriptions, journaux d’exécution et artefacts, signale les résultats réussite/avertissement/échec et peut exécuter une boucle de correction limitée avec preuves durables. |
