...
> 💡 **[Open Science v0.18.0 est disponible](https://github.com/aipoch/open-science/releases/latest)** _(dernière mise à jour : août 2026)_. Open Science v0.18.0 introduit des balises de catalogue transversales avec Favoris et tri par glisser-déposer, une gestion des compétences repensée et une place de marché des spécialistes plus rapide, avec affichage instantané depuis le cache, icônes de capacités et modification rapide de l'apparence. Les hôtes de calcul prennent désormais en charge l'authentification SSH par mot de passe avec des identifiants chiffrés par le système d'exploitation, tandis que la localisation en coréen et les guides README et de contribution multilingues élargissent l'accès. Cette version améliore aussi le chargement de la place de marché et des connecteurs, le flux d'événements d'exécution, la suppression protégée, la persistance atomique de l'accueil et la récupération au démarrage, dans les sessions, le calcul et les mises à jour. Consultez les [notes de version les plus récentes](https://github.com/aipoch/open-science/releases/latest) pour tous les détails.
