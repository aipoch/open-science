...
> 💡 **[Open Science v0.18.1 est disponible](https://github.com/aipoch/open-science/releases/latest)** _(dernière mise à jour : août 2026)_. Open Science v0.18.1 introduit la découverte d'hôtes de calcul par session et la sélection des cibles d'exécution (avec prise en charge CLI), un composant d'avis d'erreur repensé au démarrage de l'application, des alertes du centre de messages améliorées avec contexte de projet et de tâche, le repli des longs messages utilisateur, des vérifications de révision initiale vides, la localisation en français, un menu de groupe pour les compétences importées, ainsi que des commandes CLI de mise à jour de l'application et de contexte d'agent de projet ; en parallèle, les paramètres et le démarrage s'accélèrent grâce à la mise en cache des panneaux et à la réutilisation des sondes d'exécution, les modifications concurrentes de messages et de branches sont rapprochées, la provenance des artefacts de connecteur est enregistrée, les limites HTTP locales sont renforcées et des conseils de récupération de la mise à jour sont fournis. Consultez les [notes de version les plus récentes](https://github.com/aipoch/open-science/releases/latest) pour tous les détails.
