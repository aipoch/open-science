...
> 💡 **[Open Science v0.18.2 est disponible](https://github.com/aipoch/open-science/releases/latest)** _(dernière mise à jour : août 2026)_. Open Science v0.18.2 introduit la localisation en russe, la sélection de tours pour l'exportation de conversations et les clients OAuth pré-enregistrés pour les connecteurs personnalisés ; en parallèle, les résumés de liste d'agents sont réduits, l'admission incrémentielle des événements est bornée pour garder le rendu réactif pendant les flux à haut débit, les exports ZIP d'artefacts de projet sont diffusés en flux, les battements de progression MCP accompagnent le décodage UTF-8 des sources de notebook, les pièces jointes sont conservées lors de l'édition des messages, les reprises Codex opaques sont récupérées, les créations de l'API de tâches sont idempotentes, et un large ensemble de correctifs d'espace de travail, de notebook, de mise à jour et de persistance est inclus. Consultez les [notes de version les plus récentes](https://github.com/aipoch/open-science/releases/latest) pour tous les détails.
